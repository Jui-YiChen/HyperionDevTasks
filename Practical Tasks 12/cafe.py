...
#another way of doing the same task
total_stock = 0

#put all the lists into one dictionary
sample_data = {
    "menu" : ["Americano", "Latte", "Expresso", "Cookie"],
    "stock": [10,20,40,100],
    "price": [8,12,5,5]
...
#according to the position of the value, multiply the stock with the corresponding price.
...
#print out the same value as the first method.
print(total_stock)